...
def main():
    ...
    ax.set_title("SPEC_02 A/B/C ablation - m3 v9 783 rxns")
    fig.tight_layout()
    ...
    ax.legend(fontsize=9); ax.grid(alpha=0.3, axis="y")
    ax.set_title("SPEC_02 A/B/C ablation RMSE - m3 v9 783 rxns")
    fig.tight_layout()
    ...
    lines = ["# SPEC_02 A/B/C ablation - REPORT", "",
             f"- Cohort: {n_rxn} rxns (v9 in-distribution m3, 24-d, 5-fold family-stratified)",
