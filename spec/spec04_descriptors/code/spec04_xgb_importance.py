"""SPEC_04 (XGB-based descriptor contribution) - m3 v7 776 rxn cohort.
...
def main():
    ...
    fig.suptitle("SPEC_04 - XGB forward-selection saturation (m3 v7, fold-0 train)", y=1.02)
    fig.tight_layout()
