# SPEC 01-04 (m3, v7 776-rxn cohort)

Self-contained folder with the four spec analyses on the current v7 m3 pipeline.
...
- Bundle: `/gpfs/tmp_cpu2/yeseo1ee/eda_asm_features/bundles_v7/features_v7_delta_m3.pt`
- Splits: `/gpfs/tmp_cpu2/yeseo1ee/eda_asm_features/subsamples_v7/trackB_no_ood/fold{0..4}/`
...
SPEC_03 (CPU, min-hour)  parallel with SPEC_01
      |
      v
SPEC_02 direct training (GPU, hours)  needs m3 v7 bundle
      |
      v
SPEC_02 aggregate (CPU, seconds)      needs m3 v7 bdelta cells + direct cells
```
