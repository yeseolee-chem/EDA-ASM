...
Uses m3 v7 24-d bundle + adds d26/d27/d28 (SPEC_06 T1) + optional d25 (SPEC_05).
Variants:
...
D26_28_PQ = REPO / "spec/spec06_channel_proxies/data/descriptors_channel_proxies.parquet"
OUT_RES = REPO / "spec/spec06_channel_proxies/results"
OUT_FIG = REPO / "spec/spec06_channel_proxies/figures"
...
def main():
    ...
    lines = ["# SPEC_06 - channel-matched proxies (m3 v7, 776 rxns)", "",
             f"- N cohort: {n}",
