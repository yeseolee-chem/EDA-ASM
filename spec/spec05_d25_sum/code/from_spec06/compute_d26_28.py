"""SPEC_06 T1 - compute channel-matched proxies d26/d27/d28 (v9 783 cohort).
...
Charges/mults from labels/orca/orca_eda_charges_v9.parquet.
Partitions from outputs/v8_review/manual_partitions.json.

Output: /gpfs/tmp_cpu2/yeseo1ee/eda_asm_features/d26_28_v9_chunks/shard_*.parquet
"""
