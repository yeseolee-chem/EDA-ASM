...
- E_frag@TS: already available in d9, d10 of descriptors_v7.parquet (kcal/mol)
...
Reads:
  - v7 labels for cohort (776 rxns)
  - v7 orca_inp_partitions.json for frag_A/B indices
  - v7 orca_eda_charges_v7.parquet for charge/mult
...
DESC_V7     = Path("/gpfs/tmp_cpu2/yeseo1ee/eda_asm_features/descriptors_v7.parquet")
...
def main():
    ...
    desc_v7 = pd.read_parquet(DESC_V7).set_index("reaction_id")
    ...
    for i, row in labels.iterrows():
        ...
        try:
            ...
            # E(fragA @ TS) already in desc_v7.d9 (kcal/mol) but we want Hartree; recompute for consistency
