#!/bin/bash
# Phase 3 paper-exact: τ=0.05 variance-filtered features + 5 seeds
#SBATCH --job-name=ph3_paper
#SBATCH --time=48:00:00
#SBATCH --partition=cpu1,cpu2
#SBATCH --nodes=1 --ntasks=1 --cpus-per-task=4 --mem=8G
#SBATCH --array=0-4
#SBATCH --output=/gpfs/home1/yeseo1ee/projects/eda-asm-prediction/analysis/bath1480_probe/experiments/results/phase3_paper.%A_%a.log

set -uo pipefail
SEEDS=(22 23 14 1 2)
SEED=${SEEDS[$SLURM_ARRAY_TASK_ID]}
EXP=/gpfs/home1/yeseo1ee/projects/eda-asm-prediction/analysis/bath1480_probe/experiments
DATASET=$EXP/cohort_v1/phase3_dataset.pkl
...
WORK=$EXP/results/phase3_paper/seed_$SEED
...
echo "=== phase3 (τ=0.05) seed=$SEED $(date -Is) ==="
