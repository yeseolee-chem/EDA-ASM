#!/bin/bash
# ASR ADF run for reaction qmrxn20_sn2_A_E_C_B_C_B
...
#SBATCH --job-name=asr_qmrxn20_sn2_A_E_C_B_C_B
#SBATCH --ntasks=1
...
echo "=== qmrxn20_sn2_A_E_C_B_C_B START $START_UTC host=$(hostname) NSCM=$NSCM ==="
...
echo "=== qmrxn20_sn2_A_E_C_B_C_B END $END_UTC ==="
...
python /gpfs/home1/yeseo1ee/projects/eda-asm-prediction/scripts/adf/write_status.py \
    ...
    --mult-b 1 \
    --total-charge -1 \
    --dataset-delta-Ea 21.128137928761973 \
...
echo "=== qmrxn20_sn2_A_E_C_B_C_B cleanup done ==="
