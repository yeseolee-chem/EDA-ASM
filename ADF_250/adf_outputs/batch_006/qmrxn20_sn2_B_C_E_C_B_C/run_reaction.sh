#!/bin/bash
# ASR ADF run for reaction qmrxn20_sn2_B_C_E_C_B_C
...
#SBATCH --job-name=asr_qmrxn20_sn2_B_C_E_C_B_C
#SBATCH --ntasks=1
...
echo "=== qmrxn20_sn2_B_C_E_C_B_C START $START_UTC host=$(hostname) NSCM=$NSCM ==="
...
echo "=== qmrxn20_sn2_B_C_E_C_B_C END $END_UTC ==="
...
python /gpfs/home1/yeseo1ee/projects/eda-asm-prediction/scripts/adf/write_status.py \
    ...
    --mult-b 1 \
    --total-charge -1 \
    --dataset-delta-Ea 18.25904479180236 \
...
echo "=== qmrxn20_sn2_B_C_E_C_B_C cleanup done ==="
