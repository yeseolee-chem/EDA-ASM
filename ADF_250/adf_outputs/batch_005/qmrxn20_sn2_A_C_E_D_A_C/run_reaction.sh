#!/bin/bash
# ASR ADF run for reaction qmrxn20_sn2_A_C_E_D_A_C
...
#SBATCH --job-name=asr_qmrxn20_sn2_A_C_E_D_A_C
#SBATCH --ntasks=1
...
echo "=== qmrxn20_sn2_A_C_E_D_A_C START $START_UTC host=$(hostname) NSCM=$NSCM ==="
...
echo "=== qmrxn20_sn2_A_C_E_D_A_C END $END_UTC ==="
...
python /gpfs/home1/yeseo1ee/projects/eda-asm-prediction/scripts/adf/write_status.py \
    ...
    --mult-b 1 \
    --total-charge -1 \
    --dataset-delta-Ea 40.06303833324513 \
...
echo "=== qmrxn20_sn2_A_C_E_D_A_C cleanup done ==="
