#!/bin/bash
# ASR ADF run for reaction qmrxn20_e2_B_A_A_C_A_A
...
#SBATCH --job-name=asr_qmrxn20_e2_B_A_A_C_A_A
#SBATCH --ntasks=1
...
echo "=== qmrxn20_e2_B_A_A_C_A_A START $START_UTC host=$(hostname) NSCM=$NSCM ==="
...
echo "=== qmrxn20_e2_B_A_A_C_A_A END $END_UTC ==="
...
python /gpfs/home1/yeseo1ee/projects/eda-asm-prediction/scripts/adf/write_status.py \
    ...
    --mult-b 1 \
    --total-charge -1 \
    --dataset-delta-Ea -1.774475367048613 \
...
echo "=== qmrxn20_e2_B_A_A_C_A_A cleanup done ==="
