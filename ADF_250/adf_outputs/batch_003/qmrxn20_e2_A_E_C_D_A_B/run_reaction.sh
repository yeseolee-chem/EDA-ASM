#!/bin/bash
# ASR ADF run for reaction qmrxn20_e2_A_E_C_D_A_B
...
#SBATCH --job-name=asr_qmrxn20_e2_A_E_C_D_A_B
#SBATCH --ntasks=1
...
echo "=== qmrxn20_e2_A_E_C_D_A_B START $START_UTC host=$(hostname) NSCM=$NSCM ==="
...
echo "=== qmrxn20_e2_A_E_C_D_A_B END $END_UTC ==="
...
python /gpfs/home1/yeseo1ee/projects/eda-asm-prediction/scripts/adf/write_status.py \
    ...
    --mult-b 1 \
    --total-charge -1 \
    --dataset-delta-Ea 9.049628040231864 \
...
echo "=== qmrxn20_e2_A_E_C_D_A_B cleanup done ==="
