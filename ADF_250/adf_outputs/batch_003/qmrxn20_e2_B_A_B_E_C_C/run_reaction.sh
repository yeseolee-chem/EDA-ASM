#!/bin/bash
# ASR ADF run for reaction qmrxn20_e2_B_A_B_E_C_C
...
#SBATCH --job-name=asr_qmrxn20_e2_B_A_B_E_C_C
#SBATCH --ntasks=1
...
echo "=== qmrxn20_e2_B_A_B_E_C_C START $START_UTC host=$(hostname) NSCM=$NSCM ==="
...
echo "=== qmrxn20_e2_B_A_B_E_C_C END $END_UTC ==="
...
python /gpfs/home1/yeseo1ee/projects/eda-asm-prediction/scripts/adf/write_status.py \
    ...
    --mult-b 1 \
    --total-charge -1 \
    --dataset-delta-Ea 17.38728688545245 \
...
echo "=== qmrxn20_e2_B_A_B_E_C_C cleanup done ==="
