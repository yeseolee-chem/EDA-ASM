#!/bin/bash
# ASR ADF run for reaction qmrxn20_e2_B_E_A_D_C_B
...
#SBATCH --job-name=asr_qmrxn20_e2_B_E_A_D_C_B
#SBATCH --ntasks=1
...
echo "=== qmrxn20_e2_B_E_A_D_C_B START $START_UTC host=$(hostname) NSCM=$NSCM ==="
...
echo "=== qmrxn20_e2_B_E_A_D_C_B END $END_UTC ==="
...
python /gpfs/home1/yeseo1ee/projects/eda-asm-prediction/scripts/adf/write_status.py \
    ...
    --mult-b 1 \
    --total-charge -1 \
    --dataset-delta-Ea 12.17633229462525 \
...
echo "=== qmrxn20_e2_B_E_A_D_C_B cleanup done ==="
