#!/bin/bash
# ASR ADF run for reaction qmrxn20_e2_C_E_A_E_B_C
...
#SBATCH --job-name=asr_qmrxn20_e2_C_E_A_E_B_C
#SBATCH --ntasks=1
...
echo "=== qmrxn20_e2_C_E_A_E_B_C START $START_UTC host=$(hostname) NSCM=$NSCM ==="
...
echo "=== qmrxn20_e2_C_E_A_E_B_C END $END_UTC ==="
...
python /gpfs/home1/yeseo1ee/projects/eda-asm-prediction/scripts/adf/write_status.py \
    ...
    --mult-b 1 \
    --total-charge -1 \
    --dataset-delta-Ea 24.801533840507087 \
...
echo "=== qmrxn20_e2_C_E_A_E_B_C cleanup done ==="
