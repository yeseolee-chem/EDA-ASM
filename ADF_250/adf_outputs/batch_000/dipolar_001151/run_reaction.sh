#!/bin/bash
# ASR ADF run for reaction dipolar_001151
...
#SBATCH --job-name=asr_dipolar_001151
#SBATCH --ntasks=1
...
echo "=== dipolar_001151 START $START_UTC host=$(hostname) NSCM=$NSCM ==="
...
echo "=== dipolar_001151 END $END_UTC ==="
...
python /gpfs/home1/yeseo1ee/projects/eda-asm-prediction/scripts/adf/write_status.py \
    ...
    --mult-b 1 \
    --total-charge 0 \
    --dataset-delta-Ea 27.47577178927953 \
...
echo "=== dipolar_001151 cleanup done ==="
