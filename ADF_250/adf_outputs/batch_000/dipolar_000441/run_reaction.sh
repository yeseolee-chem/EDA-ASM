#!/bin/bash
# ASR ADF run for reaction dipolar_000441
...
#SBATCH --job-name=asr_dipolar_000441
#SBATCH --ntasks=1
...
echo "=== dipolar_000441 START $START_UTC host=$(hostname) NSCM=$NSCM ==="
...
echo "=== dipolar_000441 END $END_UTC ==="
...
python /gpfs/home1/yeseo1ee/projects/eda-asm-prediction/scripts/adf/write_status.py \
    ...
    --mult-b 1 \
    --total-charge 0 \
    --dataset-delta-Ea 29.60471312701762 \
...
echo "=== dipolar_000441 cleanup done ==="
