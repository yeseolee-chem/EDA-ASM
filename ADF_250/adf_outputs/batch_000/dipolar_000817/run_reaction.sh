#!/bin/bash
# ASR ADF run for reaction dipolar_000817
...
#SBATCH --job-name=asr_dipolar_000817
#SBATCH --ntasks=1
...
echo "=== dipolar_000817 START $START_UTC host=$(hostname) NSCM=$NSCM ==="
...
echo "=== dipolar_000817 END $END_UTC ==="
...
python /gpfs/home1/yeseo1ee/projects/eda-asm-prediction/scripts/adf/write_status.py \
    ...
    --mult-b 1 \
    --total-charge 0 \
    --dataset-delta-Ea 27.77404729978155 \
...
echo "=== dipolar_000817 cleanup done ==="
