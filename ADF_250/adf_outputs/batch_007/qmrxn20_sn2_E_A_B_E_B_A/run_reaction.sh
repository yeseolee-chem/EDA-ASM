#!/bin/bash
# ASR ADF run for reaction qmrxn20_sn2_E_A_B_E_B_A
...
#SBATCH --job-name=asr_qmrxn20_sn2_E_A_B_E_B_A
#SBATCH --ntasks=1
...
echo "=== qmrxn20_sn2_E_A_B_E_B_A START $START_UTC host=$(hostname) NSCM=$NSCM ==="
...
echo "=== qmrxn20_sn2_E_A_B_E_B_A END $END_UTC ==="
...
python /gpfs/home1/yeseo1ee/projects/eda-asm-prediction/scripts/adf/write_status.py \
    ...
    --mult-b 1 \
    --total-charge -1 \
    --dataset-delta-Ea 11.56979721871788 \
...
echo "=== qmrxn20_sn2_E_A_B_E_B_A cleanup done ==="
