#!/bin/bash
# ASR ADF run for reaction qmrxn20_sn2_C_E_B_E_A_A
...
#SBATCH --job-name=asr_qmrxn20_sn2_C_E_B_E_A_A
#SBATCH --ntasks=1
...
echo "=== qmrxn20_sn2_C_E_B_E_A_A START $START_UTC host=$(hostname) NSCM=$NSCM ==="
...
echo "=== qmrxn20_sn2_C_E_B_E_A_A END $END_UTC ==="
...
python /gpfs/home1/yeseo1ee/projects/eda-asm-prediction/scripts/adf/write_status.py \
    ...
    --mult-b 1 \
    --total-charge -1 \
    --dataset-delta-Ea 15.68091294332726 \
...
echo "=== qmrxn20_sn2_C_E_B_E_A_A cleanup done ==="
