#!/bin/bash
# ASR ADF run for reaction qmrxn20_sn2_E_A_D_B_B_D
...
#SBATCH --job-name=asr_qmrxn20_sn2_E_A_D_B_B_D
#SBATCH --ntasks=1
...
echo "=== qmrxn20_sn2_E_A_D_B_B_D START $START_UTC host=$(hostname) NSCM=$NSCM ==="
...
echo "=== qmrxn20_sn2_E_A_D_B_B_D END $END_UTC ==="
...
python /gpfs/home1/yeseo1ee/projects/eda-asm-prediction/scripts/adf/write_status.py \
    ...
    --mult-b 1 \
    --total-charge -1 \
    --dataset-delta-Ea 16.16478789297426 \
...
echo "=== qmrxn20_sn2_E_A_D_B_B_D cleanup done ==="
