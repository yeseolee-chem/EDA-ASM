#!/bin/bash
# ASR ADF run for reaction qmrxn20_sn2_C_E_A_C_C_C
...
#SBATCH --job-name=asr_qmrxn20_sn2_C_E_A_C_C_C
#SBATCH --ntasks=1
...
echo "=== qmrxn20_sn2_C_E_A_C_C_C START $START_UTC host=$(hostname) NSCM=$NSCM ==="
...
echo "=== qmrxn20_sn2_C_E_A_C_C_C END $END_UTC ==="
...
python /gpfs/home1/yeseo1ee/projects/eda-asm-prediction/scripts/adf/write_status.py \
    ...
    --mult-b 1 \
    --total-charge -1 \
    --dataset-delta-Ea 25.49484516604782 \
...
echo "=== qmrxn20_sn2_C_E_A_C_C_C cleanup done ==="
