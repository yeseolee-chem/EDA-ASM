#!/bin/bash
# ASR ADF run for reaction qmrxn20_sn2_E_B_E_C_A_D
...
#SBATCH --job-name=asr_qmrxn20_sn2_E_B_E_C_A_D
#SBATCH --ntasks=1
...
echo "=== qmrxn20_sn2_E_B_E_C_A_D START $START_UTC host=$(hostname) NSCM=$NSCM ==="
...
echo "=== qmrxn20_sn2_E_B_E_C_A_D END $END_UTC ==="
...
python /gpfs/home1/yeseo1ee/projects/eda-asm-prediction/scripts/adf/write_status.py \
    ...
    --mult-b 1 \
    --total-charge -1 \
    --dataset-delta-Ea 43.16520848246707 \
...
echo "=== qmrxn20_sn2_E_B_E_C_A_D cleanup done ==="
