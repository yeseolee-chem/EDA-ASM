#!/bin/bash
# ASR ADF run for reaction qmrxn20_sn2_E_A_C_E_B_B
...
#SBATCH --job-name=asr_qmrxn20_sn2_E_A_C_E_B_B
#SBATCH --ntasks=1
...
echo "=== qmrxn20_sn2_E_A_C_E_B_B START $START_UTC host=$(hostname) NSCM=$NSCM ==="
...
echo "=== qmrxn20_sn2_E_A_C_E_B_B END $END_UTC ==="
...
python /gpfs/home1/yeseo1ee/projects/eda-asm-prediction/scripts/adf/write_status.py \
    ...
    --mult-b 1 \
    --total-charge -1 \
    --dataset-delta-Ea 17.540604083833163 \
...
echo "=== qmrxn20_sn2_E_A_C_E_B_B cleanup done ==="
