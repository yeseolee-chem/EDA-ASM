...
mkdir -p models/m3/code/bundles outputs/asr_v1/phase3/subsamples
BROOT=/gpfs/tmp_cpu2/yeseo1ee/eda_asm_features/bundles_v9
SROOT=/gpfs/tmp_cpu2/yeseo1ee/eda_asm_features/subsamples_v9
ln -sf "$BROOT/features_v6_delta_m3.pt" "models/m3/code/bundles/features_v6_delta_${BASELINE}.pt"
ln -sf "$BROOT/features_v6_delta_m3.families.json" "models/m3/code/bundles/features_v6_delta_${BASELINE}.families.json"
...
RUNNER=models/m3/code/runner_lowlr_trackB_m1delta.py
n_ok=0; n_fail=0
for MEM in 0 1 2 3 4; do
  OUT="models/m3/code/trackB_${OUT_TAG}_${BASELINE}/m1_delta/fold${FOLD}/member${MEM}.json"
  if [ -f "$OUT" ]; then
