#!/bin/bash
# m2 v7 — use ORCA v7 5-channel labels + m2 descriptors (d1..d21, 21-d).
# 5 array tasks × 5 members = 25 cells.

#SBATCH --job-name=m2_v7
#SBATCH --array=0-4%3
...
#SBATCH --output=/gpfs/tmp_cpu2/yeseo1ee/eda_asm_features/spec_v1_logs/m2_v7_%A_%a.out
#SBATCH --error=/gpfs/tmp_cpu2/yeseo1ee/eda_asm_features/spec_v1_logs/m2_v7_%A_%a.err
...
rm -f m2/code/bundles/features_v6_delta_geom6.pt m2/code/bundles/features_v6_delta_geom6.families.json
ln -sf "$BROOT/features_v7_delta_m2.pt"                 m2/code/bundles/features_v6_delta_geom6.pt
ln -sf "$BROOT/features_v7_delta_m2.families.json"      m2/code/bundles/features_v6_delta_geom6.families.json
